...
export declare type MakeTrace = (valueLength?: number) => Trace;
export interface LexerResult<xToken extends Token.Any = Token.Any> {
    token: xToken;
    newIndex: number;
}
export declare type Lexer<xToken extends Token.Any> = (source: Source, cursor: Cursor) => undefined | LexerResult<xToken>;
